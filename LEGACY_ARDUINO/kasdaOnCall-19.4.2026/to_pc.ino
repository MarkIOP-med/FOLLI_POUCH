...
void printStatus(int cell) {
 ...
 // Serial.print(",  "); Serial.print(p[0] - p_start[0]);Serial.print(" , ");
 // Serial.print(",   "); Serial.print(p[1] - p_start[1]);Serial.print(" , ");
 // Serial.print(",   "); Serial.print(p[2] - p_start[2]);Serial.print(" , ");
  // Serial.print(",    "); Serial.print(p[3] - p_start[3]);Serial.print(" , ");
 Serial.println("");  

 ...
 *
 * A zone prescribed ABOVE the ceiling is clinician-controlled: shown as the
 * board runs it, but locked here. Silently clamping it down would let SET
 * quietly lower a regime the clinician set deliberately.
 */

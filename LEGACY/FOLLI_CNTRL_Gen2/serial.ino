...
void printStatusToSerial() {
  ...
  for (int i = 0; i < 4; i++) {
    ...
    Serial.print("  Actual:"); Serial.print(currentPressure_gage[i], 0);
   // Serial.print("  data: "); Serial.print(analogRead(analogPressureSensorPins[i]));
    Serial.print("  Diff:"); Serial.println(targetPressure[i] - currentPressure_gage[i], 0);
  }
  Serial.print("Manifold Gage: "); Serial.println(manifoldPressure_gage, 0);
